...
- hot reload doesn't come out of the box, you have to bolt it on. at least in python and js/ts world you have stuff like `pnpm dev` for nextjs, `flask watch` for python, ??? for fastapi. in rust you have to `cargo watch -- build`
